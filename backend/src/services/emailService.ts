...
export async function sendLeadAlert(domain: string, email: string, score: number) {
...
export async function sendTenantActivationAlert(userId: string, companyName: string, score: number) {
