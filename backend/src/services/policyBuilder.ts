...
/** A single confirmed RoPA process with its purpose and retention period */
export interface RopaProcess {
  process_name: string;
  purpose: string;
  legal_basis: string;
...
export interface PolicyData {
  ...
  /** Resolved list of external vendor/encargado names (from RoPA + TID) */
  providers?: string[];
  /** Full confirmed RoPA processes to generate granular purpose / retention table */
  ropaProcesses?: RopaProcess[];
  /** Tenant ID used to build the public ARCO+ portal link */
  tenantId?: string;
}
